...
def parse_arguments():
    ...
    parser.add_argument("--max_hits","-max", type=int, default=10000,  help="Stop screening when total hits reach this number, it  may be much higher than this limit , read comments at line 380 in the code")
